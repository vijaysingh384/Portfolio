...
function Hero() {
  ...
  return (
      ...
      <div className="relative w-full before:absolute before:top-0 before:h-px before:bg-border-primary/50 before:-left-4 before:right-[-1rem] md:before:-left-8 md:before:right-[-2rem] lg:before:inset-x-0 after:absolute after:bottom-0 after:h-px after:bg-border-primary/50 after:-left-4 after:right-[-1rem] md:after:-left-8 md:after:right-[-2rem] lg:after:inset-x-0">
        <h1
          ...
          style={{ opacity: 1, willChange: "auto", transform: "none", fontFamily: "'Syne', sans-serif", fontWeight: 800 }}
 ...
 >Hey, I'm Vijay!</span>
        ...
        <ul className="flex items-center flex-wrap gap-x-5 gap-y-4 my-10">
          ...
          <li>
            <a
              ...
              className="flex items-center gap-2 border-b border-zinc-200 group hover:border-sky-400 transition-colors"
            >
              <svg viewBox="0 0 24 24" className="h-5 w-5 text-zinc-500 group-hover:text-sky-500 duration-300" fill="currentColor">
              ...
              <span className="text-zinc-500 group-hover:text-sky-500 duration-300">GitHub</span>
            </a>
          </li>
          ...
          <li>
            <a
              ...
              className="flex items-center gap-2 border-b border-zinc-200 group hover:border-sky-400 transition-colors"
            >
              <svg viewBox="0 0 24 24" fill="currentColor" className="h-5 w-5 text-zinc-500 group-hover:text-sky-500 duration-300">
              ...
              <span className="text-zinc-500 group-hover:text-sky-500 duration-300">Leetcode</span>
            </a>
          </li>
  ...
  >
    <img src="/cv.gif" className="h-7 w-7" alt="CV" />
    View CV
  </button>
      </div>
    </div>
